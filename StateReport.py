...
if menu_id == "statereport":
    ...
    if menu_id == "opaam":
        ...
        with col1:
        #st.write("Operational Ayushman Aroygya Mandir")
        #st.write("<div style='text-align: center;'><b><h5>Operational Ayushman Arogya Mandir</h5></b></div>", unsafe_allow_html=True)
        ...
        #Total Operational AUSH
        st.write("<div style='text-align: center;'><b><h1>AYUSH Centres</h1></b></div>", unsafe_allow_html=True)        
        col1, col2=st.columns(2)
        ...
        with col1:        
            st.write("##### Total Operational AYUSH Centre")
            # Apply heatmap to the Occurrences column                        
            other_func.formattedtable(new_df) 
        # Operational AAM Tab - Target  Vs Operational graph        
        with col2:
            ...
            new_df = new_df.drop(index_to_drop)
            #new_df_filtered = new_df.data[new_df.data['District'] != 'Jharkhand Total']
            graphtitle = "Total Operational AYUSH Centre"
            primary_bar = "Target"
            secondary_bar= "Achievement"
            other_func.coloumngraph(new_df,graphtitle, primary_bar, secondary_bar)
        st.write("\n\n\n")
    ...
    if menu_id == "Daily_Report":
        ...
        with col1:            
            #table_df
            st.write("##### No. of Facility Reported Daily Entry")
            other_func.formattedtable(table_df)            
        # Monthly Report Tab - Operational Vs Monthly Report Graph
        with col2:
            graphtitle = "No. of Facility Reported Daily Entry"
            primary_bar = "Operational Facility"
        ...
        top="District"
        title="% of Daily Reporting >=20 days"        
    ...
    if menu_id == "Wellness_Report":
        ...
        with col1:            
            #table_df
            st.write("##### No. of Facility Reported Wellness Report >= 10 per month")
            other_func.formattedtable(table_df)            
        # Monthly Report Tab - Operational Vs Monthly Report Graph
        with col2:
            graphtitle = "No. of Facility Reported Wellness Entry >=10 per month"
            primary_bar = "Operational Facility"
        ...
        top="District"
        title="% of Wellness Reporting >=10 per month"        
        df=df[[top,xaxis,yaxis]]
        other_func.sortedchart(df,xaxis,yaxis,top,title)
